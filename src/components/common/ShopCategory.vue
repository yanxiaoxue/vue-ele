          ...
          <div class="shop_right">
            ...
            <h5 class="rating_order_num shop_common">
              ...
              <section class="rating_order_num_right">
                <!-- <span v-if="shop.delivery_mode.text&&shop.delivery_mode.text!=null" class="delivery_left">{{shop.delivery_mode.text}}</span> -->
                <!-- <span v-if="shop.supports[1].name" class="delivery_right">{{shop.supports[1].name}}</span> -->
              </section>
            </h5>
